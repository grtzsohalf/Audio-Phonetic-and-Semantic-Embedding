...
#exp_dir=/home/grtzsohalf/Desktop/exp
mkdir -p $exp_dir
model_dir=$exp_dir/unis/model_lr${init_lr}_$p_dim\_$s_dim\_$model_type
log_dir=$exp_dir/unis/log_lr${init_lr}_$p_dim\_$s_dim\_$model_type
...
python3 $path/src_unis/audio2vec_train.py --init_lr=$init_lr --batch_size=$batch_size --seq_len=$seq_len --feat_dim=$feat_dim \

...
parser = OptionParser()
parser.add_option("--file1", dest="filename_1",
                  help="Path to the file with embedding. If relative will load from data directory.",
                  default=None)

parser.add_option("--file2", dest="filename_2",
                  help="Path to the file with embedding. If relative will load from data directory.",
                  default=None)
...
if __name__ == "__main__":
    ...
    if not fname_1 or not fname_2:
        ...
        w_2 = load_embedding(fname_2, format=format, normalize=True, lower=True, clean_words=options.clean_words,

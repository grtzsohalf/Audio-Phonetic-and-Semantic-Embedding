...
def addParser():
    ...
    parser.add_argument('train_examples', 
        metavar='<training examples file>')    
    ...
    # parser.add_argument('train_num', 
        # metavar='<number of training data>')    
    return parser

def main():
    solver = Solver(FLAG.train_examples, FLAG.train_labels, FLAG.train_utters, FLAG.batch_size, FLAG.feat_dim, 

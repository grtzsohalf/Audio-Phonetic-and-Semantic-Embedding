...
exp_dir=$exp_dir/semantic_exps/original_2_layer_sigmoid_exp
mkdir -p $exp_dir
...
embedding_dir=$feat_dir/embedding/original_2_layer_sigmoid/${init_lr}_$dim
...
python3 $path/src/test.py --init_lr=$init_lr --batch_size=$batch_size --feat_dim=$feat_dim \
  ...
  --sampling_factor=$sampling_factor $feat_dir/original_examples_norm $feat_dir/original_words $feat_dir/original_utters \
  $embedding_dir/train_embeddings
